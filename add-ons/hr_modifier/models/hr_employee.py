...
class HrEmployeePrivate(models.Model):
    ...
    # DEPRECIATED 
    x_employee_pri = fields.Char("Employee PRI", groups="hr.group_hr_user,hr.group_hr_reporter")
    
    x_employee_job_code = fields.Char("Job code", groups="hr.group_hr_user,hr.group_hr_reporter")
